...
class SatDayViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if location == "caStation"{
            csController = caStationController(location: "caStationSat", vacation: self.vacation!)
        }else if location == "caTerminal"{
            ctController = caTerminalController(location: "caTerminalSat", vacation: self.vacation!)
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.location == "caStation"{
            return (csController?.getCell(location: "caStationSat", vacation: self.vacation!, row: indexPath.row))!
        }else{
            return (ctController?.getCell(location: "caTerminalSat", vacation: self.vacation!, row: indexPath.row))!
        }
    }
